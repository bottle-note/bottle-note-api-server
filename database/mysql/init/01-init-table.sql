...
(
    ...
    `category`       varchar(255) NOT NULL COMMENT '위스키, 럼, 브랜디의 하위상세 카테고리',
    ...
    `age`            varchar(255) NOT NULL COMMENT '숙성년도',
...
(
    ...
    `help_content`     varchar(255) NOT NULL COMMENT '문의내용 최대 1000글자',
    `status`           varchar(255) NOT NULL DEFAULT 'WAITING' COMMENT '진행상태',
    `admin_id`         bigint       NULL COMMENT '처리  어드민',
...
(
    ...
    `price`          varchar(255) NULL COMMENT '가격',
