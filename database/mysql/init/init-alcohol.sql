...
(
    ...
    `image_url`      VARCHAR(255) NULL COMMENT '썸네일 URL',
...
INSERT INTO `alcohol` (`eng_name`,
                       ...
                       `last_modify_by`)
VALUES
    ('1770 Glasgow Single Malt', '1770 글래스고 싱글 몰트', '46.0 % Vol.', 'Marriage of Ex-Bourbon & Virgin Oak Casks',
'Triple Distilled', 1, 1, 1, 'Marriage of Ex-Bourbon & Virgin Oak Casks',NULL, NULL, NULL, NULL, NULL),
       ('1770 Glasgow Single Malt', '1770 글래스고 싱글 몰트', '46.0 % Vol.', 'Virgin Oak & PX Sherry Cask Finish', 'Peated', 1,
        1, 2, 'Virgin Oak & PX Sherry Cask Finish',NULL, NULL, NULL, NULL, NULL),
       ('1770 Glasgow Single Malt', '1770 글래스고 싱글 몰트', '46.0 % Vol.', '1st fill ex-bourbon, finish virgin oak',
        'The Original - Fresh & Fruity', 1, 1, 3, '1st fill ex-bourbon, finish virgin oak', NULL,NULL, NULL, NULL, NULL),
       ('Aberfeldy 12-year-old', '애버펠디 12년', '40.0 % Vol.', NULL, 'Single Malt', 1, 2, 4, NULL,NULL, NULL, NULL, NULL, NULL),
       ('Aberfeldy 16-year-old', '애버펠디 16년', '40.0 % Vol.', 'Bourbon, 6 month finish on first fill Oloroso',
        'Single Malt', 1, 2, 5, 'Bourbon, 6 month finish on first fill Oloroso', NULL,NULL, NULL, NULL, NULL);
...
VALUES ('스코틀랜드', 'Scotland', 'GB', 'GBR', '826', 'Europe'),
...
INSERT INTO `distillery` (`kor_name`, `eng_name`, `logo_img_path`, `last_modify_at`, `last_modify_by`, `create_at`,
                          `create_by`)
