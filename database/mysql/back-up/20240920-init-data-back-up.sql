...
VALUES (1, 3, 1, '이 위스키는 풍부하고 복잡한 맛이 매력적입니다.', 'BOTTLE', 65000, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
        ...
        NULL, NULL),
       (2, 4, 1, '가벼우면서도 깊은 맛이 느껴지는 위스키입니다.', 'GLASS', 45000,  'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
        'PUBLIC', 'https://example.com/image02.jpg', NULL, 'ACTIVE', '2024-05-02 13:00:00', NULL,
        NULL, NULL),
       (3, 1, 1, '향기로운 바닐라 향이 나는 부드러운 위스키입니다.', 'BOTTLE', 77000, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
        'PUBLIC', 'https://example.com/image03.jpg', NULL, 'ACTIVE', '2024-05-16 14:30:00', NULL,
        NULL, NULL),
       (4, 2, 2, '스모키하고 강한 페트 향이 인상적인 위스키입니다.', 'BOTTLE', 120000, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
        'PUBLIC', 'https://example.com/image04.jpg', NULL, 'ACTIVE', '2024-05-01 15:45:00', NULL,
        NULL, NULL),
       (5, 5, 2, '달콤한 캐러멜과 과일 향이 조화를 이루는 맛있습니다.', 'GLASS', 99000, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
