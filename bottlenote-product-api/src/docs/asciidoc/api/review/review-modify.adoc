...
include::{snippets}/review/review-update/request-body.adoc[]
...
[discrete]
include::{snippets}/review/review-update/response-fields.adoc[]
include::{snippets}/review/review-update/http-response.adoc[]
