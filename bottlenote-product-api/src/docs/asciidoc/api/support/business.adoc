...
include::{snippets}/support/business/list/response-fields.adoc[]
include::{snippets}/support/business/list/response-body.adoc[]
...
include::{snippets}/support/business/detail/response-fields.adoc[]
include::{snippets}/support/business/detail/response-body.adoc[]
