...
class UserBasicControllerTest {
  ...
  @MockitoBean private UserBasicService userCommandService;

  @MockitoBean private DefaultUserFacade userFacade;
  ...
  void testWithdrawUserSuccess() throws Exception {
    ...
    mockMvc
        .perform(delete("/api/v1/users").contentType(MediaType.APPLICATION_JSON).with(csrf()))
