...
class CoreImageUploadServiceTest {
  private static final String ImageBucketName = "테스트-버킷-이름";
  private static final String cloudFrontUrl = "https://testUrl.cloudfront.net";
  private static final String awsUrl = "https://" + ImageBucketName + ".s3.amazonaws.com/";
  private static final String uploadAt = LocalDate.of(2024, 5, 1).format(ofPattern("yyyyMMdd"));
  private static final String fakeUUID = "ddd8d2d8-7b0c-47e9-91d0-d21251f891e8";
  ...
  void setUp() {
    ...
    imageUploadService =
        new ImageUploadService(
            resourceCommandService, new FakeAmazonS3(), ImageBucketName, cloudFrontUrl) {
          @Override
  ...
  void test_5() {
    ...
    assertTrue(
        diffInMillis < TimeUnit.SECONDS.toMillis(1), "The difference should be less than 1 second");
  }
