...
class ImageUploadControllerTest {
  ...
  void test_1(String description, ImageUploadRequest request) throws Exception {
    ...
    resultActions.andExpect(
        jsonPath("$.data.imageUploadInfo[0].uploadUrl")
            .value("https://bottlenote.s3.ap-northeast-2.amazonaws.com/images/1"));
    resultActions.andExpect(
        jsonPath("$.data.imageUploadInfo[0].viewUrl")
            .value("https://d1d1d1d1.cloudfront.net/images/1"));
  }
