...
class RestDocsFollowControllerTest extends AbstractRestDocs {
        ...
        .andDo(
            document(
                ...
                responseFields(
                    ...
                    fieldWithPath("data.followUserId")
                        .type(JsonFieldType.NUMBER)
                        .description("팔로우 유저의 아이디"),
                    fieldWithPath("data.nickName")
                        .type(JsonFieldType.STRING)
                        .description("팔로우 유저의 닉네임"),
                    fieldWithPath("data.imageUrl")
                        .type(JsonFieldType.STRING)
                        .description("팔로우 유저프로필 이미지 URL"),
  ...
  void docs_2() throws Exception {
    ...
    mockMvc
        .perform(
            get("/api/v1/follow/1/following-list")
        ...
        .andDo(
            document(
                ...
                responseFields(
                    ...
                    fieldWithPath("data.followingList[].followUserNickname")
                        .description("팔로잉한 유저의 닉네임"),
                    fieldWithPath("data.followingList[].userProfileImage")
                        .description("팔로잉한 유저의 프로필 이미지 URL"),
  ...
  void docs_3() throws Exception {
    ...
    mockMvc
        .perform(
            get("/api/v1/follow/1/follower-list")
        ...
        .andDo(
            document(
                ...
                responseFields(
                    ...
                    fieldWithPath("data.followerList[].followUserNickname")
                        .description("팔로워 유저의 닉네임"),
                    fieldWithPath("data.followerList[].userProfileImage")
                        .description("팔로워 유저의 프로필 이미지 URL"),
