...
object CurationHelper {
	...
	fun createAdminCurationListResponses(count: Int = 3): List<AdminCurationListResponse> = (1..count).map { i ->
	...
	fun createCurationStatusRequest(isActive: Boolean = true): Map<String, Any> = mapOf("isActive" to isActive)

	fun createCurationDisplayOrderRequest(displayOrder: Int = 1): Map<String, Any> = mapOf("displayOrder" to displayOrder)

	fun createCurationAlcoholRequest(alcoholIds: Set<Long> = setOf(1L, 2L)): Map<String, Any> = mapOf("alcoholIds" to alcoholIds)
