				...
				.apply(
					document(
						...
						responseFields(
							...
							fieldWithPath("data[].posterUrl").type(JsonFieldType.STRING).description("동영상 배너 대표 이미지 URL").optional(),
				...
				.apply(
					document(
						...
						requestFields(
							...
							fieldWithPath("posterUrl").type(JsonFieldType.STRING).description("동영상 배너 대표 이미지 URL (최대 500자)").optional(),
