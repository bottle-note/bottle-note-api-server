                ...
                .apply(
                    document(
                        ...
                        responseFields(
                            ...
                            fieldWithPath("data.displayOrder").type(JsonFieldType.NUMBER).description("노출 순서"),
                            fieldWithPath("data.isActive").type(JsonFieldType.BOOLEAN).description("활성화 상태"),
                            fieldWithPath("data.alcohols").type(JsonFieldType.ARRAY).description("포함된 위스키 목록"),
                            fieldWithPath("data.alcohols[].alcoholId").type(JsonFieldType.NUMBER).description("위스키 ID"),
                            fieldWithPath("data.alcohols[].korName").type(JsonFieldType.STRING).description("한글명"),
                            fieldWithPath("data.alcohols[].engName").type(JsonFieldType.STRING).description("영문명"),
                            fieldWithPath("data.alcohols[].korCategoryName").type(JsonFieldType.STRING).description("한글 카테고리명"),
                            fieldWithPath("data.alcohols[].engCategoryName").type(JsonFieldType.STRING).description("영문 카테고리명"),
