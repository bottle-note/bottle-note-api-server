...
object AdminMfdsDeclarationApiDocs {
	...
	@Tag(name = "식약처 수입 신고", description = "정제된 수입 신고 데이터를 조회하고 정규화 검토와 수입사 연결을 관리한다")
	...
	@Operation(
		...
		description = """
			정규화 상태, 주류 매칭 여부, 매칭 결정 값, 연결 수입사, 검색어로 수입 신고 목록을 조회합니다.
	...
	@Operation(
		...
		description = "신고 데이터 ID로 정제 결과 전체와 연결된 수입사 정보, 주류·증류소·지역 매칭 후보 목록을 조회합니다.",
		responses = [
			ApiResponse(
				responseCode = "200",
