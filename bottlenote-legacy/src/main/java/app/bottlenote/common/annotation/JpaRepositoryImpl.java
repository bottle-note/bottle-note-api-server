 ...
 *
 * <ul>
 *   <li>JPA 기술을 사용하는 리포지토리 구현체 식별
 *   <li>도메인 리포지토리 인터페이스의 JPA 구현임을 명시
 *   <li>인프라스트럭처 레이어에 속하는 컴포넌트 구분
 * </ul>
 *
 * <p>Spring의 @Repository를 포함하고 있어 자동으로 컴포넌트 스캔 및 영속성 예외 변환 기능을 제공합니다.
 *
 * <p>사용 예:
 *
 * <pre>{@code
