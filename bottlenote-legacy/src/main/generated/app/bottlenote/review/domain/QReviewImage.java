...
public class QReviewImage extends EntityPathBase<ReviewImage> {
    ...
    private static final long serialVersionUID = 713431270L;
    ...
    public final app.bottlenote.common.image.QImageInfo reviewImageInfo;
    ...
    public QReviewImage(Class<? extends ReviewImage> type, PathMetadata metadata, PathInits inits) {
        ...
        this.reviewImageInfo = inits.isInitialized("reviewImageInfo") ? new app.bottlenote.common.image.QImageInfo(forProperty("reviewImageInfo")) : null;
    }
