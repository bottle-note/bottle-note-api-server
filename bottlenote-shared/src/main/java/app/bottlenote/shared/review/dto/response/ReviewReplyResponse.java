...
public record ReviewReplyResponse(
    ReviewReplyResultMessage codeMessage, String message, Long reviewId, String responseAt) {
  public static ReviewReplyResponse of(ReviewReplyResultMessage message, Long reviewId) {
