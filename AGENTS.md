...
- `.Codex/skills/implement/references/mono-patterns.md` — Repository 3-Tier, Facade, DTO, Event patterns
- `.Codex/skills/implement/references/product-patterns.md` — Product controller conventions
- `.Codex/skills/implement/references/admin-patterns.md` — Admin controller conventions (Kotlin)
- `.Codex/skills/test/references/test-infra.md` — TestContainers, Fake/InMemory list
- `.Codex/skills/test/references/test-patterns.md` — Unit, integration, RestDocs code patterns
