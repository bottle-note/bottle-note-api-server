...
public class Notification extends BaseEntity {
	...
	@Builder
	public Notification(Long id, Long userId, String title, String content, NotificationType type, NotificationCategory category, NotificationStatus status, Boolean isRead) {
		this.id = id;
