...
public record HelpResultResponse(
    HelpResultMessage codeMessage, String message, Long helpId, String responseAt) {

  public static HelpResultResponse response(HelpResultMessage message, Long helpId) {
