...
public interface CustomReviewQueryRepository {
	 ...
	 * @return 베스트 리뷰 목록
	 */
	List<ReviewInfo> fetchTopReviewByAlcohol(Long alcoholId, Long userId);
	 ...
	 * @return 최신 리뷰 목록
	 */
	List<ReviewInfo> fetchLatestReviewsByAlcoholExcludingIds(Long alcoholId, Long userId, List<Long> ids);
