...
public class ReviewResponse {
	...
	public ReviewResponse(Long reviewId, BigDecimal price, SizeType sizeType, Long likeCount,
		Long replyCount,
		Long userId, String userNickname, String userProfileImage, Boolean myCommentYn,
		String status,
		Boolean myLikeYn, Boolean myReplyYn, String thumbnailImage, String createdAt) {
