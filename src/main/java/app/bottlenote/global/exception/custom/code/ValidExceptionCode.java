...
public enum ValidExceptionCode implements ExceptionCode {
	...
	REQUIRED_USER_ID(HttpStatus.BAD_REQUEST, "유저 아이디 필수입니다."),
	NOT_BLANK(HttpStatus.BAD_REQUEST, "공백은 입력할 수 없습니다."),
	NOT_NULL(HttpStatus.BAD_REQUEST, "null은 입력할 수 없습니다."),
	NOT_EMPTY(HttpStatus.BAD_REQUEST, "빈 값은 입력할 수 없습니다."),
	...
	STATUS_IS_REQUIRED(HttpStatus.BAD_REQUEST, "status는 필수입니다."),
