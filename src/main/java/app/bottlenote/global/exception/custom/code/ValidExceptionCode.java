...
public enum ValidExceptionCode implements ExceptionCode {
	...
	//REVIEW
	REVIEW_NOT_EMPTY(HttpStatus.BAD_REQUEST, "리뷰는 내용은 필수입니다."),
	...
	// LIKE
	REVIEWID_ID_REQUIRED(HttpStatus.BAD_REQUEST, "reviewId(식별자)는 필수입니다."),
	LIKE_STATUS_IS_REQUIRED(HttpStatus.BAD_REQUEST, "status는 필수입니다."),
	...
	EMAIL_NOT_BLANK(HttpStatus.BAD_REQUEST, "공백은 입력할 수 없습니다."),

	//REPORT,
	REPORT_REQUIRED_USER_ID(HttpStatus.BAD_REQUEST, "유저 아이디는 필수입니다."),
	...
	REPORT_CONTENT_NOT_BLANK(HttpStatus.BAD_REQUEST, "공백은 입력할 수 없습니다.");
