...
public class OauthService {
  ...
  private TokenItem doAppleLoginOld(
      OauthRequest oauthReq, String socialUniqueId, String email, SocialType socialType) {
    User user;
  ...
  private TokenItem doAppleLogin(
      OauthRequest oauthReq, String socialUniqueId, String email, SocialType socialType) {
    User user;
    ...
    if (socialUniqueId != null && !socialUniqueId.isBlank()) {
      ...
      if (existingUser.isPresent()) {
        ...
        log.info(
            "애플 로그인: socialUniqueId로 사용자를 찾지 못함, 새 계정 생성 시도, socialUniqueId={}", socialUniqueId);
