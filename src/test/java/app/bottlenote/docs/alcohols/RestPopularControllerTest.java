			...
			.andDo(
				document("alcohols/populars/week",
					...
					responseFields(
						...
						fieldWithPath("data.alcohols[].whiskyId").type(JsonFieldType.STRING).description("술 ID"),
						...
						fieldWithPath("data.alcohols[].rating").type(JsonFieldType.STRING).description("술 평점"),
						fieldWithPath("data.alcohols[].category").type(JsonFieldType.STRING).description("술 타입"),
						fieldWithPath("data.alcohols[].imagePath").type(JsonFieldType.STRING).description("술 이미지 URL"),
