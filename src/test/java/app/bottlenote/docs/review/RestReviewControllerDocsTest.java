			...
			.andDo(
				document("review/review-create",
					requestFields(
						...
						fieldWithPath("locationInfoRequest").type(OBJECT).description("위치 정보"),
						fieldWithPath("locationInfoRequest.locationName").type(STRING).description("상호 명").optional(),
						fieldWithPath("locationInfoRequest.zipCode").type(STRING).description("우편번호").optional(),
						fieldWithPath("locationInfoRequest.address").type(STRING).description("주소").optional(),
						fieldWithPath("locationInfoRequest.detailAddress").type(STRING).description("상세 주소").optional(),
						fieldWithPath("locationInfoRequest.category").type(STRING).description("카테고리").optional(),
						fieldWithPath("locationInfoRequest.mapUrl").type(STRING).description("지도 URL").optional(),
						fieldWithPath("locationInfoRequest.latitude").type(STRING).description("위도(x좌표)").optional(),
						fieldWithPath("locationInfoRequest.longitude").type(STRING).description("경도(y좌표)").optional(),
			...
			.andDo(
				document("review/review-read",
					...
					responseFields(
						...
						fieldWithPath("data.reviewList[].locationInfoRequest").description("리뷰 장소 정보"),
						fieldWithPath("data.reviewList[].locationInfoRequest.name").description("리뷰 장소 명"),
						fieldWithPath("data.reviewList[].locationInfoRequest.zipCode").description("리뷰 장소 우편번호"),
						fieldWithPath("data.reviewList[].locationInfoRequest.address").description("리뷰 장소 주소"),
						fieldWithPath("data.reviewList[].locationInfoRequest.detailAddress").description("리뷰 장소 상세 주소"),
						fieldWithPath("data.reviewList[].locationInfoRequest.category").description("리뷰 장소 카테고리"),
						fieldWithPath("data.reviewList[].locationInfoRequest.mapUrl").description("리뷰 장소 지도 URL"),
						fieldWithPath("data.reviewList[].locationInfoRequest.latitude").description("리뷰 장소 위도"),
						fieldWithPath("data.reviewList[].locationInfoRequest.longitude").description("리뷰 장소 경도"),
			...
			.andDo(
				document("review/review-detail-read",
					responseFields(
						...
						// Alcohol Item
						fieldWithPath("data.alcoholSummaryItem.alcoholId").description("술 ID").type(JsonFieldType.NUMBER),
						fieldWithPath("data.alcoholSummaryItem.korName").description("술의 한국어 이름").type(JsonFieldType.STRING),
						fieldWithPath("data.alcoholSummaryItem.engName").description("술의 영어 이름").type(JsonFieldType.STRING),
						fieldWithPath("data.alcoholSummaryItem.korCategoryName").description("술 카테고리의 한국어 이름").type(JsonFieldType.STRING),
						fieldWithPath("data.alcoholSummaryItem.engCategoryName").description("술 카테고리의 영어 이름").type(JsonFieldType.STRING),
						fieldWithPath("data.alcoholSummaryItem.imageUrl").description("술 이미지 URL").type(JsonFieldType.STRING),
						fieldWithPath("data.alcoholSummaryItem.isPicked").description("선택 여부").type(JsonFieldType.BOOLEAN),
						...
						// Location Item
						fieldWithPath("data.reviewInfo.locationInfoRequest").description("위치 정보").type(JsonFieldType.OBJECT).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.name").description("상호 명").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.zipCode").description("우편번호").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.address").description("주소").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.detailAddress").description("상세주소").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.category").description("카테고리").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.mapUrl").description("지도 URL").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.latitude").description("위도").type(JsonFieldType.STRING).optional(),
						fieldWithPath("data.reviewInfo.locationInfoRequest.longitude").description("경도").type(JsonFieldType.STRING).optional(),
			...
			.andDo(
				document("review/review-update",
					requestFields(
						...
						fieldWithPath("locationInfoRequest").type(OBJECT).description("위치 정보").optional(),
						fieldWithPath("locationInfoRequest.locationName").type(STRING).description("상호 명").optional(),
						fieldWithPath("locationInfoRequest.zipCode").type(STRING).description("우편번호").optional(),
						fieldWithPath("locationInfoRequest.address").type(STRING).description("주소").optional(),
						fieldWithPath("locationInfoRequest.detailAddress").type(STRING).description("상세 주소").optional(),
