...
class RestReviewReplyControllerTest extends AbstractRestDocs {
	...
	void test_1() throws Exception {
		...
		var request = ReviewReplyObjectFixture.getReviewReplyRegisterRequest("이 리뷰는 매우 유익합니다. 추천을 줄만하네요.");
	...
	@Test
	@DisplayName("댓글 목록을 조회 할 수 있다.")
	void test_2() throws Exception {
		var reviewReplyInfoList = ReviewReplyObjectFixture.getReviewReplyInfoList(5);
