...
class ReviewReplyServiceTest {
	...
	class delete {
		...
		void test_1() {
			//given
			final ReviewReply save = reviewReplyRepository.save(ReviewReplyObjectFixture.getReviewReplyFixture(99L, 1L));

			//when
			var response = reviewReplyService.deleteReviewReply(save.getReviewId(), save.getId(), save.getUserId());
		...
		void test_2() {
			...
			ReviewException aThrows = assertThrows(ReviewException.class, () -> reviewReplyService.deleteReviewReply(1L, -1L, 1L));
		...
		void test_3() {
			...
			//when && then
			ReviewException aThrows = assertThrows(ReviewException.class, () -> reviewReplyService.deleteReviewReply(save.getReviewId(), save.getId(), -1L));
