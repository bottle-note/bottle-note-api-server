...
class UserReportServiceTest {
	...
	void testUserReportWith_NullUserId() {
		// Given
		UserReportRequest request = new UserReportRequest(null, 44L, UserReportType.SPAM, "content_request_content_01");

		// When & Then
		NullPointerException aThrows = assertThrows(NullPointerException.class, () -> userReportService.userReport(request));
	...
	void testUserReportWith_NullReportUserId() {
		// Given
		UserReportRequest request = new UserReportRequest(1L, null, UserReportType.SPAM, "content_request_content_01");
	...
	void testUserReportWith_SelfReport() {
		// Given
		UserReportRequest request = new UserReportRequest(1L, 1L, UserReportType.SPAM, "content_request_content_01");

		// When & Then
		ReportException aThrows = assertThrows(ReportException.class, () -> userReportService.userReport(request));
	...
	void testUserReport() {
		...
		UserReportRequest request = new UserReportRequest(1L, 4L, UserReportType.SPAM, "content_request_content_01");
		...
		UserReportResponse response = userReportService.userReport(request);
	...
	void testUserReportWith_UserNotFoundException() {
		...
		// Then
		UserException aThrows = assertThrows(UserException.class, () -> userReportService.userReport(request));
