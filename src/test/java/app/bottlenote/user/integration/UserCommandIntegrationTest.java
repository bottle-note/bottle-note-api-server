...
class UserCommandIntegrationTest extends IntegrationTestSupport {
	...
	void test_4() throws Exception {
		...
		String responseString = result.getResponse().getContentAsString(StandardCharsets.UTF_8);
		GlobalResponse response = mapper.readValue(responseString, GlobalResponse.class);
		NicknameChangeResponse nicknameChangeResponse = mapper.convertValue(response.getData(), NicknameChangeResponse.class);
	...
	void test_6() throws Exception {
		...
		String responseString = result.getResponse().getContentAsString(StandardCharsets.UTF_8);
		GlobalResponse response = mapper.readValue(responseString, GlobalResponse.class);
		ProfileImageChangeResponse profileImageChangeResponse = mapper.convertValue(response.getData(), ProfileImageChangeResponse.class);
