package app.docs.support.report;
...
class RestDocsReportCommandControllerTest extends AbstractRestDocs {
  ...
  void reportUserTest() throws Exception {
    ...
    mockMvc
        ...
        .andDo(
            document(
                "support/report/user-report",
                requestFields(
                    fieldWithPath("reportUserId")
                        .type(JsonFieldType.NUMBER)
                        .description("신고 대상자 유저 ID(신고를 당하는 유저"),
                    fieldWithPath("type")
                        .type(JsonFieldType.STRING)
                        .description(
                            "신고 타입  ( SPAM , INAPPROPRIATE_CONTENT ,FRAUD ,COPYRIGHT_INFRINGEMENT ,OTHER )"),
                ...
                responseFields(
                    ...
                    fieldWithPath("data.reportId")
                        .type(JsonFieldType.NUMBER)
                        .description("처리된 신고 ID"),
                    fieldWithPath("data.reportUserId")
                        .type(JsonFieldType.NUMBER)
                        .description("신고 대상 유저 ID"),
                    fieldWithPath("data.reportUserName")
                        .type(JsonFieldType.STRING)
                        .description("신고 대상 유저 이름"),
