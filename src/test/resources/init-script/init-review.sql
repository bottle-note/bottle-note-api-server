insert into review (user_id, alcohol_id, is_best,content, size_type, price,  location_name, street_address, category, map_url, latitude, longitude,
                    status, image_url, view_count, active_status, create_at, create_by, last_modify_at,
                    last_modify_by)
values (2, 1, true,'식별자 1번 임의리 리뷰', 'GLASS', 20000.00,'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
       ...
       (2, 1, false,'식별자 2번 임의리 리뷰입니다.', 'GLASS', 20000.00, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
        'PUBLIC','https://bottlenote.s3.ap-northeast-2.amazonaws.com/images/1', null, 'ACTIVE', '2024-06-08 16:24:01', null,
        '2024-06-14 20:44:58', null),
       (2, 1, false,'맛있게 잘 먹었습니다. ', 'GLASS', 20000.00, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
       ...
       (2, 4, false,'맛있게 잘 먹었습니다.ggg ', 'GLASS', 20000.00, 'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
       ...
       (4, 4, false,'역시 맛났다!!.......', 'BOTTLE', 12000.00,'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
       ...
       (4, 4, false,'역시 맛났다!!', 'GLASS', 12000.00,'xxPub', '서울시 청담동', 'bar','xxx@example.com','12.123','12.123',
