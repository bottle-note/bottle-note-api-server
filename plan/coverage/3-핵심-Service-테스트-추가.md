...
**왜 80%인가?**
- 업계 표준: 70-80%가 대부분의 프로젝트에 권장됨
- 핵심 비즈니스 로직 (ReviewService, AlcoholViewHistoryService)은 85% 목표
- 중요 시나리오에 집중, 모든 엣지 케이스를 다 커버할 필요는 없음
- 80% 이상에서는 시간 대비 버그 발견율 급격히 감소 (실증적 근거)
