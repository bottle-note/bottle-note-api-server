...
================================================================================
Status: **STALE**
First Drafted: 2026-03-24
Marked Stale: 2026-05-08

** Reason **
- 작성 후 1.5개월 이상 진척 마크 부재
- UserHistory 영역에서 부분 수정 (e.g. c6ad66d4 fix(history): ViewHistory 동기화 시 중복 키 에러 수정) 만 들어왔고, 본 문서가 제안한 3단계(발행 → 수집 → 저장) 전체 리팩토링은 미진행
- 가이드성 문서 비중이 커서 활성 plan 단위로 추적하기 부적합

** Recommended Next Step **
- 실제 리팩토링 착수 시 본 문서를 base 로 재정의해 새 plan 으로 작성
- 그 전까지는 stale 폴더에 보존하여 활성 plan 디렉토리 시그널을 유지
================================================================================
```
