...
public class DailyDataReportQuartzJob extends BatchQuartzJob {
	 ...
	 */
	public DailyDataReportQuartzJob(JobLauncher jobLauncher, JobRegistry jobRegistry, AppInfoConfig appInfoConfig) {
	...
	protected void executeInternal(@NonNull JobExecutionContext context) throws JobExecutionException {
		if (DEV_BRANCH.equals(appInfoConfig.getGitBranch())) {
