...
public record TokenSaveResponse(String deviceToken, Platform platform, TokenMessage message) {
  public static TokenSaveResponse of(String deviceToken, Platform platform, TokenMessage message) {
