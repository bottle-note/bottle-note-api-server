...
public enum NotificationEventAction {
  ...
  HELP_ANSWER(
      ...
      "문의 답변",
      "내가 등록한 문의에 관리자 답변이 등록된 경우 발생하는 알림",
      true),
  REPORT_RESULT(
      NotificationSettingGroup.MY_ACTIVITY,
      "신고 처리 결과",
      "내가 접수한 신고의 처리 결과가 안내되는 경우 발생하는 알림",
      true),
  CONTENT_MODERATION(
      NotificationSettingGroup.MY_ACTIVITY,
      "내 콘텐츠 숨김·삭제",
