...
public class BusinessImageList {
  ...
  public List<BusinessImage> makeBusinessImageList(
      List<BusinessImageItem> images, Long businessSupportId) {
    List<BusinessImage> businessImageList =
        images.stream()
            .map(
                image ->
                    BusinessImage.builder()
                        .businessImageInfo(
                            ImageInfo.builder()
                                .order(image.order())
