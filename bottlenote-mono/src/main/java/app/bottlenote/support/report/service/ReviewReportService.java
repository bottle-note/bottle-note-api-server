...
public class ReviewReportService {
  ...
  public ReviewReportResponse reviewReport(
      Long currentUserId, ReviewReportRequest reviewReportRequest, String clientIP) {
    ...
    reviewReportRepository
        .findByUserIdAndReviewId(currentUserId, reportReviewId)
        .ifPresentOrElse(
            reviewReport -> {
