 ...
 * <p>
 * 5가지 원칙:
 * 1. 단일 책임: Help 엔티티 생성만
 * 2. 격리: em.flush()로 즉시 반영
 * 3. 순수성: EntityManager만 사용
 * 4. 명시성: @NotNull/@Nullable 명시
 * 5. 응집성: 다른 팩토리 의존 없음
 */
@Component
...
public class HelpTestFactory {
	...
	@Transactional
	@NotNull
	public List<Help> persistMultipleHelpsByUser(@NotNull Long userId, @NotNull HelpType type, int count) {
